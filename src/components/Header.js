    ...
    <div className="header-wraper" id="header">
      <div className="main-info">
        ...
        <div className='mb-5 d-flex flex-column d-md-flex flex-md-row'>
          <a href="./img/matthieu_resume.pdf" download="matthieu_resume.pdf" target="blank" className="btn-main-offer mb-2 mx-3 quicksand-font">Get my resume</a>
        </div>
        <div className='row'>
          ...
          <a className='sm-icon col h4' href="mailto:senoumatthieu96@gmail.com" target="blank"><i className="bi bi-envelope"></i></a>
        </div>
      </div>
    </div>
  )
